...
ANDROID_SNS_ARN_PROD = os.environ.get('ANDROID_SNS_ARN_PROD', 'arn:aws:sns:ap-southeast-1:500556504508:app/GCM/prod-gc24-android')
ANDROID_SNS_ARN_DEV  = os.environ.get('ANDROID_SNS_ARN_DEV', 'arn:aws:sns:ap-southeast-1:500556504508:app/GCM/dev-gc24-android')
IOS_SNS_ARN_DEV      = os.environ.get('ANDROID_SNS_ARN_DEV', 'arn:aws:sns:ap-southeast-1:500556504508:app/APNS/dev-gc24-ios')
IOS_SNS_ARN_PROD     = os.environ.get('ANDROID_SNS_ARN_DEV', 'arn:aws:sns:ap-southeast-1:500556504508:app/APNS/prod-gc24-ios')
