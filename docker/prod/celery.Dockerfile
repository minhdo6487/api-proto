...
COPY GolfConnect/prod_settings.py GolfConnect/settings.py
...
CMD celery worker -A GolfConnect -B --loglevel=INFO -s /usr/src/app/media/celerybeat-schedule
